...
public class PorvisionalInformation {
	JFrame f;
	JScrollPane sp;
	JTable  tbl; 
	Connection cn;
	...
	PorvisionalInformation(String a,String b,String c)
	{
		Connection con;
		try
		{
			...
			f=new JFrame("Porvisional List Details");
	...
	{
		 System.out.println("Privisional List Details");
		new PorvisionalInformation("first_year","CM","2014-2015");
	}
}
