...
public class FinalList extends JFrame
{
	...
	//String s1[]={"EnrollmentNo","Acdamic_year","Name","Branch","Year","Category","DOB","Marks","Address","Annual_income","Parent_income","Phone_no"};
	...
	int cnt5=0;
	@SuppressWarnings("unchecked")
	FinalList(String a,String b,String c)
	{
		Vector data;
		Vector heads;
...
//		heads.addElement("Phone_no");
		...
		try
		{
			...
			String Query1="SELECT EnrollmentNo,Acdamic_year,Name,Year,Branch,Category,Marks FROM "+a+" where Year='"+b+"' AND Acdamic_year='"+c+"' order by Marks DESC"; 
...
//								v.addElement(rs1.getString("Phone_no"));
			...
			JFrame f=new JFrame("Final List");
			tbl=new JTable(data,heads);
			System.out.println("i am here ..");
			tbl.setColumnSelectionInterval(6, 6);
	...
	{
		new FinalList("first_year","CM","2013-2014");
	}
}